...
export const module2MathQuestGame: MathQuestGame = {
  id: 'mathquest-module-2',
  moduleId: 'module-2',
  title: 'Math Quest: Wizard\'s Tower',
  description: 'Climb the Wizard\'s Tower by writing Python math expressions to solve challenges on each floor!',
  pointsPerFloor: 100,
  timeBonusMax: 50,
  timeLimitSeconds: 60,
